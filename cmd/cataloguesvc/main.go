...
func main() {
	var (
		...
		dsn    = flag.String("DSN", "catalogue_user:default_password@tcp(" + os.Getenv("MYSQL_HOSTNAME") + ":" + os.Getenv("MYSQL_PORT") + ")/socksdb", "Data Source Name: [username[:password]@][protocol[(address)]]/dbname")
